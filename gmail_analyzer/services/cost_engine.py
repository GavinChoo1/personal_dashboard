...
from gmail_analyzer.models import Subscription, BillingInvoice
        ...
        return {
            ...
            "apis": [
                ...
                },
                {
                    ...
                    "purpose": "Historical SQL warehouse (partitioned messages, threads, actions, subscriptions)",
                    "usage": "Active dataset: gmail_analyzer • 4 partitioned tables",
                    "free_tier_quota": "10.0 GB active storage + 1.0 TB query data / month",
                    "quota_consumed": "< 0.01%",
                    "incurred_cost": 0.00,
                    "pricing_rate": "$0.00 within free tier (then $0.02/GB)",
                    "status": "Active / Live",
                },
                {
                    "name": "Vertex AI (aiplatform.googleapis.com)",
                    "purpose": "Gemini AI model inference & task extraction",
                    "usage": "On-demand invocation",
                    "free_tier_quota": "Pay-per-token / Free credits available",
                    "quota_consumed": "0.0%",
                    "incurred_cost": 0.00,
                    "pricing_rate": "$0.00 within free tier",
                    "status": "Active / Live",
                }
            ]
        }
