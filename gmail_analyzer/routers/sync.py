...
from gmail_analyzer.models import EmailMessage, SyncState
from backend.dashboard.services.gcs_service import gcs_service
from gmail_analyzer.services.gmail_service import gmail_service
...
@router.post("/clear")
def clear_data():
    from gmail_analyzer.seed_gmail_data import clear_all_data
    try:
        clear_all_data()
...
@router.post("/seed")
def trigger_seed():
    from gmail_analyzer.seed_gmail_data import seed_database
    try:
        seed_database()
